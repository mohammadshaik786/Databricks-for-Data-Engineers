...
# MAGIC %fs head dbfs:/mnt/training/definitive-guide/data/activity-data-stream.json/part-00000-tid-8123838261124416299-3821b8a3-5a80-49f2-b6fe-6183e02fdda8-278553-c000.json
...
initialDF.select("Model").where("Device == nexus4_2")

# COMMAND ----------

initialDF.groupBy("Model").count()

# COMMAND ----------

display(streamingDF.show())

# COMMAND ----------

display(streamingDF.groupBy().count())
...
print(outputPathDir,checkpointPath)
...
display(streamingDF.groupBy("Model").count())
...
# MAGIC %fs ls dbfs:/user/ms6bz@umsystem.edu/structured-streaming-concepts/python/output.parquet
