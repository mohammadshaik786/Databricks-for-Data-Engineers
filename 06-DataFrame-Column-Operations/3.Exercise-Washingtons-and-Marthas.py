...
washingtons = (spark
               ...
               .collect() # this functions retuen all records as a dataset or array of records i.e Return all records as an array to the Driver
              )
...
marthas = (spark
           ...
           .cache()
           .where("project == 'en'")
           .where(col("article").startswith("Martha_") == True)
          )
marthas = marthas.take(marthas.count()) # This converts into array of records 
totalMarthas = 0
