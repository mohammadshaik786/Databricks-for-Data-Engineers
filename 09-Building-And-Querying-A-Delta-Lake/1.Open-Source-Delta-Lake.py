...
# Forget to add in the notebook for initializing userhome
...
display(dbutils.fs.ls("dbfs:/user/ms6bz@umsystem.edu/delta/customer-data/"))

# COMMAND ----------

# MAGIC %fs ls dbfs:/user/ms6bz@umsystem.edu/delta/customer-data/
...
upsertDF = spark.read.json("/mnt/training/enb/commonfiles/upsert-data.json")
display(upsertDF)
