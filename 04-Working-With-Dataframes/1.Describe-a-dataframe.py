...
path = userhome + "/wikipedia/pagecounts/staging_parquet_en_only_clean/"
files = dbutils.fs.ls(path)
display(files)

# COMMAND ----------

# Instead of dbutils.fs.ls(), we can use the below cmd

# COMMAND ----------

# MAGIC %fs ls /mnt/training/wikipedia/pagecounts/
...
# Since we are not using Azure Databricks, just using community edition version
